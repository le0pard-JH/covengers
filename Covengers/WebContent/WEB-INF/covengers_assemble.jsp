...
section#services {
	background-image: url( "images/adproduct6.png" );
}
  ...
  <header id="header" class="fixed-top header-transparent">
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        ...
        <li><a href="<%=ctxPath%>/myPage/myPage.com">My Page</a></li>
          
        <li><a href="#adproduct">Recommanded Product</a></li>
        ...
        <li class="drop-down"><a href="<%=ctxPath%>/product/productDisplay.com">Product</a>
	       ...
	       <li class="drop-down"><a href="#">INCENSE</a>
			<ul>
		   	  <c:forEach var="list" items="${categoryInfo}" varStatus="status">
				<c:if test="${list.fk_kindcode eq 'IS'}">
				  <li><a href="<%=ctxPath%>/product/productDisplay.com?categorycode=${list.fk_categorycode}">${list.encategoryname}</a></li>
				</c:if>
		      </c:forEach>
			</ul>
  ...
  <main id="main">
    ...
    <div id="adproduct">
	    <c:forEach var="svo" items="${plist}" varStatus="status">
		    <section id="services" class="services" style="background-image: url( 'images/adproduct${status.count}.png' )">
		      <div class="container" >
		        ...
		        <div class="row">
		          <div class="col-md-24 col-lg-24 d-flex align-items-stretch mb-5 mb-lg-0">
		            <div class="descBox" data-aos="fade-up">
		              <h4 class="title">${svo.krproductname}</h4>
		              <p class="description">${svo.productdescshort}</p>
	...
	<!-- <img id="gif" src="assets\giphy.gif"> --> <!-- 구름사진~~ -->
    ...
    <section id="cta" class="cta">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          <h3></h3>
          <p></p>
          <a class="cta-btn" href="<%=ctxPath%>/product/productDetail.com">제품둘러보기</a>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links" data-aos="fade-up" data-aos-delay="150">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="<%=ctxPath%>/product/productDetail.com">Product</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="<%=ctxPath%>/myPage/myPage.com">My Page</a></li>
            </ul>
          </div>
